  ...
  return (
    <TooltipProvider>
      <div className="h-screen flex flex-col text-white">
          ...
          <div className="md:hidden bg-gray-900 border-b border-gray-800 p-4 space-y-3 relative z-10">
            ...
            <div className="flex flex-wrap gap-2">
              <Button
                ...
                className={
                  showFolders
                    ...
                    : "border-gray-700 text-gray-400 hover:bg-gray-800 bg-transparent"
                }
              >
                <FolderOpen className="h-4 w-4 mr-1" />
                Files
              ...
              <Button
                size="sm"
                onClick={() => setShowCloudStorage(!showCloudStorage)}
                variant={showCloudStorage ? "default" : "outline"}
                className={
                  showCloudStorage
                    ? "bg-gray-700 text-silver-100 border-gray-600"
                    : "border-gray-700 text-gray-400 hover:bg-gray-800 bg-transparent"
        ...
        {/* Language Selector */}
        <div className="px-4 py-3 border-b bg-gray-900 border-gray-800">
          <LanguageSelector
        ...
        <div className="flex-1 flex overflow-hidden">
          ...
          {/* Code Editor */}
          <div className={`${getPanelWidth()} flex flex-col border-r border-gray-800`}>
          ...
          {showAI && (
            <div
              className={`${getPanelWidth()} ${showCollaboration || showCloudStorage ? "border-r border-gray-800" : ""}`}
            >
              <AIAssistant
          ...
          {/* Collaboration Panel */}
          {showCollaboration && (
            <div className={`${getPanelWidth()} ${showCloudStorage ? "border-r border-gray-800" : ""}`}>
              <CollaborationSystem
